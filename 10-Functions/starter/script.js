...
newPassport(jonas);
checkIn(flight, jonas);
// javascript에는 Passing by Reference는 없고 오직 Passing by value만 있을 뿐이다.
*/
...
const poll = {
  ...
  registerNewAnswer() {
    ...
    //   console.log(answer);
    //   poll.answers[answer]++;
    //   const input2 = prompt('type');
    //   this.displayResults(input2);
    // } else {
...
const boardPassengers = function (n, wait) {
  ...
  // Callback function work independantly
