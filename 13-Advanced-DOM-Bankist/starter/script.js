...
console.log(allButtons); // return HTMLCollection -> life collection // dom change -> life collection change emediately
...
// header.prepend(message); // header 의 첫번째 child, Dom elements는 unique
header.append(message); // header 의 마지막 child
...
message.style.width = '120%'; // tag 안에 쓰여있는 인라인 스타일
...
// Non-standard
console.log(logo.designer); // Only Standard Attribute
...
*/
////////////////////////////////////////////////////////////////
/* 186. Type of events and Event Handlers
...
document.querySelector('.nav').addEventListener(
  ...
  // true // capturing phase 사용 여부
);
*/

// 190. DOM Traversing
// DOM의 위 아래 옆의 element들, Node들을 선택하는 방법
/*
const h1 = document.querySelector('h1');
...
console.log(h1.parentElement, 'h');

h1.closest('.header').style.background='var(--gradient-secondary)';
h1.closest('h1').style.background='var(--gradient-primary)';

// Going sideways: siblings
console.log(h1.previousElementSiblicng);
