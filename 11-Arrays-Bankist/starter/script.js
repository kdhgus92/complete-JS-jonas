...
console.log(arr2); // mutate original array
...
movements.forEach(function (mov, i, arr) {
  // current value, index, array order fixed
  if (mov > 0) {
...
3. For eachremaining dog, log to the console whether it's an adult ("Dog number 1 is an adult, and is 5 years old") or a puppy ("Dog number 2 is still a puppy🐶")
...
const calcAverageHumanAge = function (ages) {
  ...
  const filteredHumanAge = humanAges.filter(humanAge => {
    return humanAge >= 18;
  });
  // const avgFilterdHumanAge =
  //   filteredHumanAge.reduce((acc, age) => {
  //     return acc + age;
  //   }, 0) / filteredHumanAge.length;

  const avgFilterdHumanAge = filteredHumanAge.reduce(
